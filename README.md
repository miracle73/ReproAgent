...
The JSON manifest records the pipeline revision, resolved parameters, input hashes, container metadata, reference, seeds, complete decision trace, model settings and host versions. Diff reports contain both Markdown and machine-readable JSON.
