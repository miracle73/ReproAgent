...
def test_replay_uses_manifest_only(tmp_path):
    manifest = RunManifest(run_id="r1", created_utc="2025-01-01T00:00:00Z", pipeline=PipelineInfo(name="nf-core/sarek", revision="3.5.1"), profile="test,docker", params={"genome": "GRCh38"}, llm=LLMInfo(model="mock"), host_env=HostEnv())
